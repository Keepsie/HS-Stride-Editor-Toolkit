...
{
    /// <summary>
    /// Scans Stride asset files to find all referenced namespaces
    /// </summary>
    public class NamespaceScanner
    {
        /// <summary>
        /// Scans all Stride asset files in a directory for namespace references
        /// </summary>
        ...
        /// <summary>
        /// Scans all Stride asset files in a directory for namespace references, excluding specified namespaces
        /// </summary>
        ...
        /// <summary>
        /// Scans a single Stride asset file for namespace references
        /// </summary>
